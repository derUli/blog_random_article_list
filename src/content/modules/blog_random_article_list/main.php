...
function blog_random_article_list_render() {
    ...
    if ($limit_amount) {
        ...
        return "<div class='ulicms-error'>Bitte setzen Sie die Konfigurationsvariable blog_random_article_list_amount</div>";
    }

    $blog_page_url = getconfig("blog_page_url");
    if (!$blog_page_url) {
        return "<div class='ulicms-error'>Bitte setzen Sie die Konfigurationsvariable blog_page_url</div>";
    }
